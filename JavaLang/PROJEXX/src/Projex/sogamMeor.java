...
public class sogamMeor extends JPanel {

	/**
	 * Create the panel.
	 */
	public sogamMeor() throws Exception {
		setSize(new Dimension(1920, 1080));
		setLayout(null);
		
		JLabel selfpic = new JLabel("");
		selfpic.setIcon(new ImageIcon("ProjectData\\picMeor.jpg"));
		selfpic.setBorder(new MatteBorder(5, 5, 5, 5, (Color) new Color(0, 0, 128)));
		...
		titlebio.setBorder(new MatteBorder(0, 0, 4, 0, (Color) new Color(0, 0, 128)));
		titlebio.setForeground(Color.BLUE);
		titlebio.setFont(new Font("Batang", Font.BOLD, 60));
		titlebio.setBounds(467, 11, 277, 73);
		panelbio.add(titlebio);
		
		JTextArea bio = new JTextArea();
		bio.setOpaque(false);
		bio.setEditable(false);
		bio.setForeground(new Color(0, 255, 255));
		bio.setFont(new Font("Batang", Font.BOLD, 40));
		bio.setText("학번:52051217021\r\n\r\r\n생일:2/09/1999\r\n\r\r\n이메일: aiman.meor@gmail.com\r\n\r\r\n전화 번호: +60 17-470 5893\r\r\n\r\r\n");
		bio.setBounds(10, 95, 1191, 355);
		panelbio.add(bio);
		
		JTextArea quote = new JTextArea();
		quote.setEditable(false);
		quote.setOpaque(false);
		quote.setForeground(new Color(0, 255, 255));
		quote.setFont(new Font("Lucida Calligraphy", Font.BOLD | Font.ITALIC, 48));
		quote.setText("   \"Life too short, dont study hard. \r\n                                            Love asian\"");
		quote.setBounds(10, 449, 1191, 136);
		panelbio.add(quote);
		...
		titlesogam.setBorder(new MatteBorder(0, 0, 4, 0, (Color) new Color(0, 0, 128)));
		titlesogam.setForeground(new Color(0, 0, 255));
		...
		sogam.setForeground(new Color(0, 255, 255));
		sogam.setEditable(false);
		sogam.setFont(new Font("Batang", Font.BOLD | Font.ITALIC, 38));
		sogam.setBounds(10, 112, 1091, 329);
		panelsogam.add(sogam); 
		
		
		try{
        String strLine;
        File selectedFile = new File("meor.txt");
		...
		titlegall.setBorder(new MatteBorder(0, 0, 4, 0, (Color) new Color(0, 0, 128)));
		titlegall.setForeground(new Color(0, 0, 255));
		titlegall.setFont(new Font("Batang", Font.BOLD, 60));
		titlegall.setBounds(464, 5, 283, 81);
		panelgall.add(titlegall);
		
		JLabel galleryMeor = new JLabel("New label");
		galleryMeor.setIcon(new ImageIcon("ProjectData\\gallMeor.png"));
		galleryMeor.setBounds(10, 78, 1191, 762);
		panelgall.add(galleryMeor);
		...
		JLabel nametitle = new JLabel("MEOR ANWAR AIMAN BIN MEOR MOHD ZUMIR");
		nametitle.setForeground(new Color(0, 0, 255));
		nametitle.setFont(new Font("Mistral", Font.BOLD, 53));
		nametitle.setBounds(476, 29, 968, 58);
		add(nametitle);
		
		JLabel mainbg = new JLabel("");
		mainbg.setIcon(new ImageIcon("ProjectData\\bgMeor.jpg"));
